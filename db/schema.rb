...
ActiveRecord::Schema.define(version: 2020_09_03_095632) do
  ...
  create_table "orders_details", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["cat_picture_id"], name: "index_orders_details_on_cat_picture_id"
  ...
  add_foreign_key "orders_details", "cat_pictures"
